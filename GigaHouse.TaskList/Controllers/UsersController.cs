...
using GigaHouse.Application.Users.Create;
using GigaHouse.Application.Users.Get;
using GigaHouse.Application.Users.Delete;
using NLog;
...
public class UsersController : BaseController
{
    ...
    public async Task<IActionResult> Save([FromBody] CreateRequest request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            response.Status = Core.Enums.UserStatus.Pending.ToString();
