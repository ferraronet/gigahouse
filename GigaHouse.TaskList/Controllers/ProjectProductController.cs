using AutoMapper;
using GigaHouse.Application.ProjectProducts.Create;
using GigaHouse.Application.ProjectProducts.Delete;
using GigaHouse.Application.ProjectProducts.Get;
using GigaHouse.Application.ProjectProducts.GetList;
using GigaHouse.Application.ProjectProducts.Update;
...
namespace GigaHouse.TaskList.Controllers
{
    ...
    public class ProjectProductController : ControllerBase
    {
        ...
        public ProjectProductController(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
