using AutoMapper;
using GigaHouse.Application.ProjectCssSelectors.Create;
using GigaHouse.Application.ProjectCssSelectors.Delete;
using GigaHouse.Application.ProjectCssSelectors.Get;
using GigaHouse.Application.ProjectCssSelectors.GetList;
using GigaHouse.Application.ProjectCssSelectors.Update;
...
namespace GigaHouse.TaskList.Controllers
{
    ...
    public class ProjectCssSelectorController : ControllerBase
    {
        private static readonly Logger _logger = LogManager.GetCurrentClassLogger();
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public ProjectCssSelectorController(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> GetList([FromQuery] Guid projectId, CancellationToken cancellationToken = default)
        {
            try
            {
                var request = new GetListRequest { ProjectId = projectId };
        ...
        public async Task<IActionResult> Save([FromBody] CreateRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    Success = true,
                    Message = "ProjectCssSelector created successfully",
                    Data = response
                });
            }
            catch (Exception error)
        ...
        public async Task<IActionResult> Get([FromRoute] Guid id, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    Success = true,
                    Message = "ProjectCssSelectors retrieved successfully",
        ...
        public async Task<IActionResult> Delete([FromRoute] Guid id, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    Success = true,
                    Message = "ProjectCssSelector deleted successfully"
                });
            }
            catch (KeyNotFoundException notFoundException)
            {
        ...
        public async Task<IActionResult> Edit([FromBody] UpdateRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (getResponse == null)
                    return NotFound($"ProjectCssSelector with ID {request.Id} not found");
                ...
                {
                    Success = true,
                    Message = "ProjectCssSelector Updated successfully",
                    Data = response
                });
            }
            catch (KeyNotFoundException notFoundException)
